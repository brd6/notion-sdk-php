...
- Embed blocks now preserve their `caption` during hydration and serialization, including on create.

## 1.12.7 - 2026-09-07

### Fixed

- Paragraph blocks now preserve optional icons during hydration and serialization.
- Heading blocks now preserve their `is_toggleable` state during hydration and serialization, including explicit false values.

## 1.12.6 - 2026-08-24

### Fixed

- Pages containing Notion Button properties now hydrate into typed read-only resources instead of throwing `UnsupportedPropertyValueException`.
